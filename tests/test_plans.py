...
@pytest.mark.parametrize("test_input, name, fds, fc1, fc2, field", [
    ('pw7', 'PW7', 'ELE_PW7', 'ELE_PW7_KABEL', 'AWK_PW7_HALTUNG', 'TRASSE_REF7'),
    (('pw1000', None, {'user_prefix': 'USR'}),
     'USR_PW1000', 'USR_ELE_PW1000', 'USR_ELE_PW1000_KABEL', 'USR_AWK_PW1000_HALTUNG', 'TRASSE_REF1000'),
    ...
    ('pw1000', 'U_PW1000', 'U_ELE_PW1000', 'U_ELE_PW1000_KABEL', 'U_AWK_PW1000_HALTUNG', 'TRASSE_REF1000'),
    ('u_pw1000', 'U_PW1000', 'U_ELE_PW1000', 'U_ELE_PW1000_KABEL', 'U_AWK_PW1000_HALTUNG', 'U_TRASSE_REF1000'),
    ('GP1001', 'U_GP1001', 'U_ELE_GP1001', 'U_ELE_GP1001_KABEL', 'U_AWK_GP1001_HALTUNG', 'TRASSE_REF1001'),
])
def test_gnplanhelper_good(test_input, name, fds, fc1, fc2, field):
    ...
    assert ph.get_field_name('trasse_ref') == field
